...
http://terraunity.com/freedownload/TerraLandStreaming_WorldMachine.zip
...
If you are looking for generating database server from scratch by yourself, download original World Machine
heigtmap & splatmap renders from here:
http://terraunity.com/freedownload/TerraLandStreaming_WorldMachineRenders.zip


The original World Machine renders has been created by Midge Sinnaeve.
https://themantissa.net/blog/landscape-pack

Other useful free source to download World Machine renders and check with TerraLand Offline Streaming system.
https://www.tfmstyle.com/world-machine-pack/
